...
- (NSDictionary*)dictionaryRepresentation
{
    ...
    [mutableDict setValue:[NSArray arrayWithArray:tempArrayForSsheaderinfo] forKey:kRouteDetailsSsheaderinfo];
    ...
    [mutableDict setValue:[NSArray arrayWithArray:tempArrayForWaypoints] forKey:kRouteDetailsWaypoints];
