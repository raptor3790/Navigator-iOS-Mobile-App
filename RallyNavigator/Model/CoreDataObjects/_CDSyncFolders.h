...
// Make changes to CDSyncFolders.h instead.

#import <CoreData/CoreData.h>

extern const struct CDSyncFoldersAttributes {
...
} CDSyncFoldersAttributes;

@interface CDSyncFoldersID : NSManagedObjectID {}
@end

@interface _CDSyncFolders : NSManagedObject {}
+ (id)insertInManagedObjectContext:(NSManagedObjectContext*)moc_;
+ (NSString*)entityName;
+ (NSEntityDescription*)entityInManagedObjectContext:(NSManagedObjectContext*)moc_;
@property (nonatomic, readonly, strong) CDSyncFoldersID* objectID;
...
@interface _CDSyncFolders (CoreDataGeneratedPrimitiveAccessors)
