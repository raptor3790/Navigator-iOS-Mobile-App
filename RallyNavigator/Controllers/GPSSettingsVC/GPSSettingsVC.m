    ...
    [UIAlertAction actionWithTitle:@"Set"
                           ...
                           handler:^(UIAlertAction *action) {
                               ...
                               switch (indexPath.row)
                               {
                                   case GPSRecordingAccuracyTrackPointRecordingFrequency:
                                   {
                                       _trackPointFrequency = [strFrequency doubleValue];
                                       
                                       [_tblGPSSettings beginUpdates];
                                       [_tblGPSSettings reloadRowsAtIndexPaths:@[[NSIndexPath indexPathForRow:GPSRecordingAccuracyTrackPointRecordingFrequency inSection:0]] withRowAnimation:UITableViewRowAnimationFade];
                                       [_tblGPSSettings endUpdates];
                                       ...
                                       objConfig.accuracy.distance = _trackPointFrequency;
                                       ...
                                       if ([_delegate respondsToSelector:@selector(updateTrackPointRecordingFrequency:)])
                                       {
                                           [_delegate updateTrackPointRecordingFrequency:_trackPointFrequency];
                                       }
                                   }
                                       break;
                                   ...
                                   case GPSRecordingAccuracyTrackPointAngleFilter:
                                   {
                                       _trackPointAngle = [strFrequency doubleValue];
                                       
                                       [_tblGPSSettings beginUpdates];
                                       [_tblGPSSettings reloadRowsAtIndexPaths:@[[NSIndexPath indexPathForRow:GPSRecordingAccuracyTrackPointAngleFilter inSection:0]] withRowAnimation:UITableViewRowAnimationFade];
                                       [_tblGPSSettings endUpdates];
                                       ...
                                       NSDictionary *jsonDict = [RallyNavigatorConstants convertJsonStringToObject:objUser.config];
                                       Config *objConfig = [[Config alloc] initWithDictionary:jsonDict];
                                       objConfig.accuracy.angle = _trackPointAngle;
                                       ...
                                       if ([_delegate respondsToSelector:@selector(updateTrackPointAngle:)])
                                       {
                                           [_delegate updateTrackPointAngle:_trackPointAngle];
                                       }
                                   }
                                       break;
                                   ...
                                   case GPSRecordingAccuracyTulipAngle:
                                   {
                                       _tulipAngle = [strFrequency doubleValue];
                                       
                                       [_tblGPSSettings beginUpdates];
                                       [_tblGPSSettings reloadRowsAtIndexPaths:@[[NSIndexPath indexPathForRow:GPSRecordingAccuracyTulipAngle inSection:0]] withRowAnimation:UITableViewRowAnimationFade];
                                       [_tblGPSSettings endUpdates];
                                       ...
                                       NSDictionary *jsonDict = [RallyNavigatorConstants convertJsonStringToObject:objUser.config];
                                       Config *objConfig = [[Config alloc] initWithDictionary:jsonDict];
                                       objConfig.accuracy.minDistanceTrackpoint = _tulipAngle;
                                       objConfig.autoCamera = TRUE;
                                       ...
                                       if ([_delegate respondsToSelector:@selector(updateTulipAngleDistance:)])
                                       {
                                           [_delegate updateTulipAngleDistance:_tulipAngle];
                                       }
                                   }
                                       break;
