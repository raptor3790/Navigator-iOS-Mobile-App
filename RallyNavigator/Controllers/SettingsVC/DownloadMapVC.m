...
//                             [_mapView removeAnnotations:_mapView.annotations];
                             ...
                             CLLocationCoordinate2D cord1 = [_mapView convertPoint:CGPointMake(CGRectGetWidth(_lblOverlay2.frame), CGRectGetMaxY(_lblOverlay2.frame)) toCoordinateFromView:self.view];
                             CLLocationCoordinate2D cord2 = [_mapView convertPoint:CGPointMake(CGRectGetMinX(_lblOverlay3.frame), CGRectGetMaxY(_lblOverlay1.frame)) toCoordinateFromView:self.view];
                             
                             cordBounds = MGLCoordinateBoundsMake(cord1, cord2);
