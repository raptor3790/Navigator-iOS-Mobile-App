...
- (IBAction)syncStarted:(id)sender
{
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        _lblSync.text = [NSString stringWithFormat: @"Saving Roadbooks to Server - %d%%",((int)(percentage * 100))];
        
        _heightLblSync.constant = 30.0f;
            ...
            if (_isOverlayTrack)
            {
                ...
                dispatch_async(dispatch_get_main_queue(), ^{
                    [self dismissViewControllerAnimated:YES completion:^{
                        ...
                        {
                            [_delegate didPickRoadbookWithId:strRoadbookId];
                        }
                    }];
                });
            }
                                                 ...
                                                 [self presentConfirmationAlertWithTitle:@"Delete Folder"
                                                                   ...
                                                                   withCancelButtonTitle:@"Cancel"
                                                                      ...
                                                                      withExecutionBlock:^{
                                                                          ...
                                                                          CDFolders *objRoadBook = _arrFolders[indexPath.row];
